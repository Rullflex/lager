...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var lazysizes__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lazysizes */ \"./node_modules/lazysizes/lazysizes.js\");\n/* harmony import */ var lazysizes__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lazysizes__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var uikit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! uikit */ \"./node_modules/uikit/dist/js/uikit.js\");\n/* harmony import */ var uikit__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(uikit__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _modules_scripts_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../modules/scripts/_core */ \"./src/modules/scripts/_core.js\");\n\n\n\ndocument.addEventListener(\"DOMContentLoaded\", function () {\n  var _document$querySelect;\n\n  var app = new _modules_scripts_core__WEBPACK_IMPORTED_MODULE_2__[\"App\"]();\n  app.init(); //SECTION 2\n\n  if (window.innerWidth < app.lg) {\n    uikit__WEBPACK_IMPORTED_MODULE_1___default.a.slider(\".s2__tab\");\n  }\n\n  var tabReorder = function tabReorder() {\n    var set = document.querySelectorAll(\".s2__tab .s2__tab-item\");\n    var length = set.length;\n    var center = Math.floor(length / 2);\n    var currentActiveIndex = app.getIndexOfElements(document.querySelector(\".s2__tab .s2__tab-item.switcher-active\"), set);\n    var startIndex = length - (currentActiveIndex - center);\n\n    if (startIndex >= length) {\n      startIndex = startIndex - length;\n    }\n\n    set.forEach(function (e, idx) {\n      var i = idx + startIndex;\n\n      if (i >= length) {\n        i -= length;\n      }\n\n      e.classList.remove('center');\n      e.style.order = i;\n\n      switch (i) {\n        case 0:\n        case 6:\n          e.style.fontSize = '20px';\n          e.style.opacity = '0.3';\n          break;\n\n        case 1:\n        case 5:\n          e.style.fontSize = '22px';\n          e.style.opacity = '0.5';\n          break;\n\n        case 2:\n        case 4:\n          e.style.fontSize = '24px';\n          e.style.opacity = '1';\n          break;\n\n        default:\n          e.style.fontSize = '26px';\n          e.style.opacity = '1';\n          e.classList.add('center');\n          break;\n      }\n    });\n  };\n\n  uikit__WEBPACK_IMPORTED_MODULE_1___default.a.switcher(\".s2__slide-tab\", {\n    connect: \".s2__slide-items\",\n    cls: \"switcher-active\",\n    animation: 'uk-animation-fade',\n    swiping: false\n  });\n  document.querySelectorAll(\".s2__slide-btn\").forEach(function (el) {\n    el.addEventListener(\"click\", function (ev) {\n      ev.preventDefault();\n      var idx = app.getIndexOfElements(document.querySelector(\".s2__slide-tab .switcher-active\"), document.querySelector(\".s2__slide-tab .switcher-active\").parentElement.children);\n      uikit__WEBPACK_IMPORTED_MODULE_1___default.a.switcher(\".s2__slide-tab\").show(idx + 1);\n    });\n  });\n  document.querySelectorAll(\"li.s2__slide-content\").forEach(function (el, idx) {\n    el.addEventListener(\"beforeshow\", function (event) {\n      var idx = app.getIndexOfElements(event.target, event.target.parentElement.children);\n\n      if (window.innerWidth < app.lg) {\n        uikit__WEBPACK_IMPORTED_MODULE_1___default.a.slider(\".s2__tab\").show(idx);\n      } else {\n        tabReorder();\n      }\n    });\n  }); // END SECTION 2\n  //SECTION 3\n\n  if (window.innerWidth < app.lg) {\n    uikit__WEBPACK_IMPORTED_MODULE_1___default.a.drop('.s3__tab-drop', {\n      mode: 'click'\n    });\n  }\n\n  uikit__WEBPACK_IMPORTED_MODULE_1___default.a.switcher(\".s3__slide-tab\", {\n    connect: \".s3__slide-items\",\n    cls: \"switcher-active\",\n    animation: 'uk-animation-fade',\n    active: ((_document$querySelect = document.querySelector(\".s3__widget[data-active-index]\")) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.getAttribute('data-active-index')) || 0\n  });\n  document.querySelectorAll(\"li.s3__slide-content\").forEach(function (el, idx) {\n    el.addEventListener(\"beforeshow\", function (event) {\n      if (window.innerWidth < app.lg) {\n        document.querySelector(\".s3__tab-dropbtn span\").innerText = document.querySelector(\".s3__tab-item.switcher-active\").innerText;\n        uikit__WEBPACK_IMPORTED_MODULE_1___default.a.drop('.s3__tab-drop').hide(0);\n      }\n    });\n  }); //END SECTION 3\n  //SECTION 4\n\n  if (window.innerWidth < app.lg) {\n    uikit__WEBPACK_IMPORTED_MODULE_1___default.a.slider(\".s4__tab\");\n  }\n\n  uikit__WEBPACK_IMPORTED_MODULE_1___default.a.switcher(\".s4__slide-tab\", {\n    connect: \".s4__slide-items\",\n    cls: \"switcher-active\",\n    animation: 'uk-animation-fade',\n    swiping: false\n  });\n  document.querySelectorAll(\".s4__slide-btn\").forEach(function (el) {\n    el.addEventListener(\"click\", function (ev) {\n      ev.preventDefault();\n      var idx = app.getIndexOfElements(document.querySelector(\".s4__slide-tab .switcher-active\"), document.querySelector(\".s4__slide-tab .switcher-active\").parentElement.children);\n      uikit__WEBPACK_IMPORTED_MODULE_1___default.a.switcher(\".s4__slide-tab\").show(idx + 1);\n    });\n  });\n  document.querySelectorAll(\"li.s4__slide-content\").forEach(function (el, idx) {\n    el.addEventListener(\"beforeshow\", function (event) {\n      var idx = app.getIndexOfElements(event.target, event.target.parentElement.children);\n      uikit__WEBPACK_IMPORTED_MODULE_1___default.a.slider(\".s4__tab\").show(idx);\n    });\n  }); //END SECTION 4\n  //SECTION 5\n\n  if (window.innerWidth < app.lg) {\n    uikit__WEBPACK_IMPORTED_MODULE_1___default.a.drop('.s5__tab-drop', {\n      mode: 'click'\n    });\n  }\n\n  uikit__WEBPACK_IMPORTED_MODULE_1___default.a.switcher(\".s5__slide-tab\", {\n    connect: \".s5__slide-items\",\n    cls: \"switcher-active\",\n    animation: 'uk-animation-fade'\n  });\n  document.querySelectorAll(\"li.s5__slide-content\").forEach(function (el, idx) {\n    el.addEventListener(\"beforeshow\", function (event) {\n      if (window.innerWidth < app.lg) {\n        document.querySelector(\".s5__tab-dropbtn .date\").innerText = document.querySelector(\".s5__tab-item.switcher-active .date\").innerText;\n        document.querySelector(\".s5__tab-dropbtn .descr\").innerText = document.querySelector(\".s5__tab-item.switcher-active .descr\").innerText;\n        uikit__WEBPACK_IMPORTED_MODULE_1___default.a.drop('.s5__tab-drop').hide(0);\n      }\n    });\n  }); //END SECTION 5\n  //SECTION 11\n\n  if (window.innerWidth < app.lg) {\n    uikit__WEBPACK_IMPORTED_MODULE_1___default.a.slider(\".s11__tab\");\n  }\n\n  uikit__WEBPACK_IMPORTED_MODULE_1___default.a.switcher(\".s11__slide-tab\", {\n    connect: \".s11__slide-items\",\n    cls: \"switcher-active\",\n    animation: 'uk-animation-fade',\n    swiping: false\n  });\n  document.querySelectorAll(\"li.s11__slide-content\").forEach(function (el, idx) {\n    el.addEventListener(\"beforeshow\", function (event) {\n      var idx = app.getIndexOfElements(el, el.parentElement.children);\n      uikit__WEBPACK_IMPORTED_MODULE_1___default.a.slider(\".s11__tab\").show(idx);\n    });\n  }); //END SECTION 11\n  // MAP SECTION\n\n  uikit__WEBPACK_IMPORTED_MODULE_1___default.a.scrollspy(\".s9__map\");\n  document.querySelector(\".s9__map\").addEventListener(\"inview\", function (event) {\n    document.querySelector(\".s9__map-script\").insertAdjacentHTML(\"beforeend\", \"<iframe src=\\\"\".concat(document.querySelector(\".s9__map\").getAttribute('data-src'), \"\\\" style=\\\"border:0;\\\" allowfullscreen=\\\"\\\" loading=\\\"lazy\\\"></iframe>\"));\n  }); //VIDEO\n\n  uikit__WEBPACK_IMPORTED_MODULE_1___default.a.scrollspy(\"#video60\");\n  document.querySelector(\"#video60\").addEventListener(\"inview\", function (event) {\n    document.querySelector(\"#video60 .popup__body\").insertAdjacentHTML(\"beforeend\", \"<iframe class=\\\"embed-responsive-item\\\" src=\\\"https://www.youtube-nocookie.com/embed/\".concat(document.querySelector(\"#video60\").getAttribute('data-youtube-id'), \"\\\" frameborder=\\\"0\\\" allowfullscreen=\\\"true\\\" data-uk-video data-uk-responsive\\\"></iframe>\"));\n  });\n});\n\n//# sourceURL=webpack:///./src/assets/scripts/main.js?");

/***/ }),

/***/ "./src/modules/scripts/_core.js":
/*!**************************************!*\
  !*** ./src/modules/scripts/_core.js ***!
  \**************************************/
/*! exports provided: App, Quiz, Form */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"App\", function() { return App; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"Quiz\", function() { return Quiz; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"Form\", function() { return Form; });\n/* harmony import */ var uikit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! uikit */ \"./node_modules/uikit/dist/js/uikit.js\");\n/* harmony import */ var uikit__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(uikit__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var validate_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! validate.js */ \"./node_modules/validate.js/validate.js\");\n/* harmony import */ var validate_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(validate_js__WEBPACK_IMPORTED_MODULE_1__);\nfunction _typeof(obj) { \"@babel/helpers - typeof\"; if (typeof Symbol === \"function\" && typeof Symbol.iterator === \"symbol\") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === \"function\" && obj.constructor === Symbol && obj !== Symbol.prototype ? \"symbol\" : typeof obj; }; } return _typeof(obj); }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function\"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) _setPrototypeOf(subClass, superClass); }\n\nfunction _setPrototypeOf(o, p) { _setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return _setPrototypeOf(o, p); }\n\nfunction _createSuper(Derived) { var hasNativeReflectConstruct = _isNativeReflectConstruct(); return function _createSuperInternal() { var Super = _getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = _getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }\n\nfunction _possibleConstructorReturn(self, call) { if (call && (_typeof(call) === \"object\" || typeof call === \"function\")) { return call; } return _assertThisInitialized(self); }\n\nfunction _assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return self; }\n\nfunction _isNativeReflectConstruct() { if (typeof Reflect === \"undefined\" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === \"function\") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }\n\nfunction _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); }\n\nfunction _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }\n\nfunction _nonIterableSpread() { throw new TypeError(\"Invalid attempt to spread non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _iterableToArray(iter) { if (typeof Symbol !== \"undefined\" && Symbol.iterator in Object(iter)) return Array.from(iter); }\n\nfunction _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return _arrayLikeToArray(arr); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\n\nvar App = /*#__PURE__*/function () {\n  function App() {\n    var _this = this;\n\n    _classCallCheck(this, App);\n\n    this.isMobile = {\n      Android: function Android() {\n        return navigator.userAgent.match(/Android/i);\n      },\n      BlackBerry: function BlackBerry() {\n        return navigator.userAgent.match(/BlackBerry/i);\n      },\n      iOS: function iOS() {\n        return navigator.userAgent.match(/iPhone|iPad|iPod/i);\n      },\n      Opera: function Opera() {\n        return navigator.userAgent.match(/Opera Mini/i);\n      },\n      Windows: function Windows() {\n        return navigator.userAgent.match(/IEMobile/i);\n      },\n      any: function any() {\n        return _this.isMobile.Android() || _this.isMobile.BlackBerry() || _this.isMobile.iOS() || _this.isMobile.Opera() || _this.isMobile.Windows();\n      }\n    };\n    this.md = 768;\n    this.lg = 1280;\n    this._apiBase = '/api/';\n  }\n\n  _createClass(App, [{\n    key: \"init\",\n    value: function init() {\n      // FORM\n      var form = new Form();\n      form.init();\n    } // plural(number, ['год', 'года', 'лет'])\n\n  }, {\n    key: \"plural\",\n    value: function plural(number, titles) {\n      var cases = [2, 0, 1, 1, 1, 2];\n      return titles[number % 100 > 4 && number % 100 < 20 ? 2 : cases[number % 10 < 5 ? number % 10 : 5]];\n    } // параллакс на элемент, должен иметь класс и data-parallax-k=\"10xx\"\n\n  }, {\n    key: \"mouseMove\",\n    value: function mouseMove() {\n      var mouseMoveItemSelector = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '.mouse-parallax';\n      window.addEventListener('mousemove', function (e) {\n        var x = e.clientX / window.innerWidth;\n        var y = e.clientY / window.innerHeight;\n        document.querySelectorAll(mouseMoveItemSelector).forEach(function (e) {\n          e.style.transform = \"translate(\".concat(-x * e.getAttribute('data-parallax-k'), \"px, \").concat(-y * e.getAttribute('data-parallax-k'), \"px)\");\n        });\n      });\n    }\n  }, {\n    key: \"matchMediaListener\",\n    value: function matchMediaListener(breakpoint, callbackLessThan, callbackBiggerThan) {\n      var mediaQuery = window.matchMedia(\"(min-width: \".concat(breakpoint, \"px)\"));\n\n      function handleBreakpointCross(e) {\n        // Check if the media query is true\n        if (e.matches) {\n          callbackBiggerThan();\n        } else {\n          callbackLessThan();\n        }\n      } // Register event listener\n\n\n      mediaQuery.addListener(handleBreakpointCross); // Initial check\n\n      handleBreakpointCross(mediaQuery);\n    } // меняют класс акстивности в сетах\n\n  }, {\n    key: \"changeActivitySet\",\n    value: function changeActivitySet(set, index) {\n      var activeClass = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : \"active\";\n      set.forEach(function (e) {\n        return e.classList.remove(activeClass);\n      });\n      set[index].classList.add(activeClass);\n    }\n  }, {\n    key: \"changeActivityElement\",\n    value: function changeActivityElement(el) {\n      var activeClass = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : \"active\";\n      el.parentElement.childNodes.forEach(function (e) {\n        return e.classList.remove(activeClass);\n      });\n      el.parentElement.children[this.showIndex(el, el.parentElement.children)].classList.add(activeClass);\n    } // возвр. индекс элемента в сете\n\n  }, {\n    key: \"getIndexOfElements\",\n    value: function getIndexOfElements(el, set) {\n      return _toConsumableArray(set).indexOf(el);\n    } // при любом изменении слайда возвращает его индекс в CB функцию\n\n  }, {\n    key: \"sliderSpy\",\n    value: function sliderSpy(slider) {\n      var callback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function (index) {};\n      document.querySelectorAll(\"\".concat(slider, \" .uk-slider-items > li\")).forEach(function (el, idx) {\n        el.addEventListener(\"beforeitemshow\", function (event) {\n          var target = event.target;\n          callback(_toConsumableArray(target.parentElement.children).indexOf(target));\n        });\n      });\n    } // маска для телефонов\n\n  }, {\n    key: \"PhoneMask\",\n    value: function PhoneMask(input) {\n      if (input) {\n        var _getInputNumbersValue = function _getInputNumbersValue(input) {\n          // Return stripped input value — just numbers\n          return input.value.replace(/\\D/g, '');\n        };\n\n        var _onPhonePaste = function _onPhonePaste(e) {\n          var input = e.target,\n              inputNumbersValue = _getInputNumbersValue(input);\n\n          var pasted = e.clipboardData || window.clipboardData;\n\n          if (pasted) {\n            var pastedText = pasted.getData('Text');\n\n            if (/\\D/g.test(pastedText)) {\n              // Attempt to paste non-numeric symbol — remove all non-numeric symbols,\n              // formatting will be in onPhoneInput handler\n              input.value = inputNumbersValue;\n              return;\n            }\n          }\n        };\n\n        var _onPhoneInput = function _onPhoneInput(e) {\n          var input = e.target,\n              inputNumbersValue = _getInputNumbersValue(input),\n              selectionStart = input.selectionStart,\n              formattedInputValue = \"\";\n\n          if (!inputNumbersValue) {\n            return input.value = \"\";\n          }\n\n          if (input.value.length != selectionStart) {\n            // Editing in the middle of input, not last symbol\n            if (e.data && /\\D/g.test(e.data)) {\n              // Attempt to input non-numeric symbol\n              input.value = inputNumbersValue;\n            }\n\n            return;\n          }\n\n          if ([\"7\", \"8\", \"9\"].indexOf(inputNumbersValue[0]) > -1) {\n            if (inputNumbersValue[0] == \"9\") inputNumbersValue = \"7\" + inputNumbersValue;\n            var firstSymbols = inputNumbersValue[0] == \"8\" ? \"8\" : \"+7\";\n            formattedInputValue = input.value = firstSymbols + \" \";\n\n            if (inputNumbersValue.length > 1) {\n              formattedInputValue += '(' + inputNumbersValue.substring(1, 4);\n            }\n\n            if (inputNumbersValue.length >= 5) {\n              formattedInputValue += ') ' + inputNumbersValue.substring(4, 7);\n            }\n\n            if (inputNumbersValue.length >= 8) {\n              formattedInputValue += '-' + inputNumbersValue.substring(7, 9);\n            }\n\n            if (inputNumbersValue.length >= 10) {\n              formattedInputValue += '-' + inputNumbersValue.substring(9, 11);\n            }\n          } else {\n            formattedInputValue = '+' + inputNumbersValue.substring(0, 16);\n          }\n\n          input.value = formattedInputValue;\n        };\n\n        var _onPhoneKeyDown = function _onPhoneKeyDown(e) {\n          // Clear input after remove last symbol\n          var inputValue = e.target.value.replace(/\\D/g, '');\n\n          if (e.keyCode == 8 && inputValue.length == 1) {\n            e.target.value = \"\";\n          }\n        };\n\n        input.addEventListener('keydown', _onPhoneKeyDown);\n        input.addEventListener('input', _onPhoneInput, false);\n        input.addEventListener('paste', _onPhonePaste, false);\n      }\n\n      this.isComplete = function () {\n        var inputNumbersValue = getInputNumbersValue(input);\n\n        if ([\"7\", \"8\", \"9\"].indexOf(inputNumbersValue[0]) > -1) {\n          return inputNumbersValue.length === 11 ? true : false;\n        } else {\n          return inputNumbersValue.length >= 11 ? true : false;\n        }\n      };\n\n      this.checkCompleteness = function (anyFormatNumber) {\n        if (anyFormatNumber) {\n          var inputNumbersValue = anyFormatNumber.replace(/\\D/g, '');\n\n          if ([\"7\", \"8\", \"9\"].indexOf(inputNumbersValue[0]) > -1) {\n            return inputNumbersValue.length === 11 ? true : false;\n          } else {\n            return inputNumbersValue.length >= 11 ? true : false;\n          }\n        } else {\n          return false;\n        }\n      };\n\n      this.destroy = function () {\n        input.removeEventListener('keydown', onPhoneKeyDown);\n        input.removeEventListener('input', onPhoneInput, false);\n        input.removeEventListener('paste', onPhonePaste, false);\n      };\n\n      return this;\n    }\n  }]);\n\n  return App;\n}();\n\nvar Quiz = /*#__PURE__*/function (_App) {\n  _inherits(Quiz, _App);\n\n  var _super = _createSuper(Quiz);\n\n  function Quiz() {\n    var _this2;\n\n    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},\n        selector = _ref.selector,\n        _ref$autoMoveDelay = _ref.autoMoveDelay,\n        autoMoveDelay = _ref$autoMoveDelay === void 0 ? 0 : _ref$autoMoveDelay,\n        _ref$activeClass = _ref.activeClass,\n        activeClass = _ref$activeClass === void 0 ? \"quiz-active\" : _ref$activeClass,\n        _ref$startSlide = _ref.startSlide,\n        startSlide = _ref$startSlide === void 0 ? 0 : _ref$startSlide;\n\n    _classCallCheck(this, Quiz);\n\n    _this2 = _super.call(this);\n    _this2.selector = selector;\n    _this2.autoMoveDelay = autoMoveDelay;\n    _this2.activeClass = activeClass;\n    _this2.currentSlide = startSlide;\n    _this2.setOfSlides = document.querySelectorAll(\"\".concat(selector, \" .quiz-slide\"));\n    _this2.numberOfSlides = _this2.setOfSlides.length;\n    _this2.lastIndex = _this2.numberOfSlides - 1;\n    _this2.quiz = document.querySelector(_this2.selector);\n    return _this2;\n  }\n\n  _createClass(Quiz, [{\n    key: \"create\",\n    value: function create() {\n      var _this3 = this;\n\n      this.toSlide(this.currentSlide);\n      this.quiz.querySelectorAll(\".quiz-radio\").forEach(function (elem, idx, parent) {\n        elem.addEventListener(\"click\", function (event) {\n          var target = event.currentTarget;\n          target.closest(\".quiz-radio-wrap\").querySelectorAll(\".quiz-radio\").forEach(function (e) {\n            return e.classList.remove(_this3.activeClass);\n          });\n          target.classList.add(_this3.activeClass); // setTimeout( () => this.toNextSlide(), this.autoMoveDelay)\n\n          _this3.toNextSlide();\n        });\n      }); // bind action on buttons prev/next\n\n      this.quiz.querySelector(\".quiz-btn-prev\").addEventListener(\"click\", function (ev) {\n        _this3.toPrevSlide();\n      });\n      this.quiz.querySelector(\".quiz-btn-next\").addEventListener(\"click\", function (ev) {\n        _this3.toNextSlide();\n      });\n    }\n  }, {\n    key: \"refreshValues\",\n    value: function refreshValues() {\n      this.quiz.querySelector(\".quiz-progress-bar\").style.cssText = \"width: \".concat(100 / (this.numberOfSlides - 1) * this.currentSlide, \"%\");\n      this.quiz.querySelector(\".quiz-progress-num\").innerText = this.currentSlide + 1;\n\n      if (this.currentSlide === this.lastIndex) {\n        // финальный слайд\n        this.onFinalSlideShow();\n        this.quiz.querySelectorAll(\".quiz-final-hide\").forEach(function (el) {\n          return el.classList.add(\"hidden\");\n        });\n        this.quiz.querySelectorAll(\".quiz-final-show\").forEach(function (el) {\n          return el.classList.remove(\"hidden\");\n        });\n\n        if (window.innerWidth < this.lg) {//изменение высот\n          // this.quiz.querySelector(`.quiz-slide-wrap`).style.cssText = `height: 27rem`\n        }\n      } else {\n        // остальные слайды\n        this.quiz.querySelectorAll(\".quiz-final-hide\").forEach(function (el) {\n          return el.classList.remove(\"hidden\");\n        });\n        this.quiz.querySelectorAll(\".quiz-final-show\").forEach(function (el) {\n          return el.classList.add(\"hidden\");\n        });\n\n        if (window.innerWidth < this.lg) {//изменение высот\n          // this.quiz.querySelector(`.quiz-slide-wrap`).style.cssText = `\n          // height: ${this.quiz.querySelector(`.quiz-slide.${this.activeClass} .quiz-radio-wrap`).clientHeight + this.quiz.querySelector(`.quiz-slide.${this.activeClass} h3`).clientHeight + 30}px`\n        }\n      }\n    }\n  }, {\n    key: \"toNextSlide\",\n    value: function toNextSlide() {\n      if (this.currentSlide < this.lastIndex) {\n        this.toSlide(this.currentSlide + 1);\n      } else {\n        console.error(\"Error in Quiz.toNextSlide(): last slide cannot be passed\");\n      }\n    }\n  }, {\n    key: \"toPrevSlide\",\n    value: function toPrevSlide() {\n      if (this.currentSlide > 0) {\n        this.toSlide(this.currentSlide - 1);\n      } else {\n        console.error(\"Error in Quiz.toPrevSlide(): first slide cannot be passed\");\n      }\n    }\n  }, {\n    key: \"toSlide\",\n    value: function toSlide(position) {\n      if (position >= 0 && position <= this.lastIndex) {\n        this.setOfSlides[this.currentSlide].classList.remove(this.activeClass);\n        this.currentSlide = position;\n        this.setOfSlides[this.currentSlide].classList.add(this.activeClass);\n        this.refreshValues();\n      } else {\n        console.error(\"Error in Quiz.toSlide(): position is invalid\");\n      }\n    }\n  }, {\n    key: \"onFinalSlideShow\",\n    value: function onFinalSlideShow() {\n      var _this4 = this;\n\n      this.quiz.querySelector(\"form .values\").innerHTML = \"\";\n      this.quiz.querySelectorAll(\".quiz-slide\").forEach(function (el) {\n        var list = [];\n        el.querySelectorAll(\".\".concat(_this4.activeClass)).forEach(function (e) {\n          return list.push(e.getAttribute(\"data-value\"));\n        });\n\n        _this4.quiz.querySelector(\"form .values\").insertAdjacentHTML('beforeend', \"<input type=\\\"hidden\\\" name=\\\"\".concat(el.getAttribute(\"data-title\"), \"\\\" value=\\\"\").concat(list.join(\", \"), \"\\\">\"));\n      });\n    }\n  }, {\n    key: \"reset\",\n    value: function reset() {\n      this.toSlide(0);\n    }\n  }]);\n\n  return Quiz;\n}(App);\n\nvar Form = /*#__PURE__*/function (_App2) {\n  _inherits(Form, _App2);\n\n  var _super2 = _createSuper(Form);\n\n  function Form() {\n    var _this5;\n\n    _classCallCheck(this, Form);\n\n    _this5 = _super2.call(this);\n    _this5.selectorMessages = \".messages\";\n    _this5.classHasError = \"has-error\";\n    _this5.classHasSuccess = \"has-success\";\n    _this5.formInput = \".input-wrap\";\n    _this5.disableIMask = false, _this5.disableMessages = true, _this5.removeErrorOnFocus = true, _this5.constraints = {\n      email: {\n        // Email is required\n        presence: true,\n        // and must be an email (duh)\n        email: true\n      },\n      password: {\n        // Password is also required\n        presence: true,\n        // And must be at least 5 characters long\n        length: {\n          minimum: 5\n        }\n      },\n      \"confirm-password\": {\n        // You need to confirm your password\n        presence: true,\n        // and it needs to be equal to the other password\n        equality: {\n          attribute: \"password\",\n          message: \"^The passwords does not match\"\n        }\n      },\n      \"Имя\": {\n        // You need to pick a username too\n        presence: true,\n        // And it must be between 3 and 20 characters long\n        length: {\n          minimum: 3,\n          maximum: 20\n        },\n        format: {\n          // We don't allow anything that a-z and 0-9\n          pattern: \"[А-яA-z ]+\",\n          // but we don't care if the username is uppercase or lowercase\n          flags: \"i\",\n          message: \"Только русские буквы\"\n        }\n      },\n      // birthdate: {\n      //   // The user needs to give a birthday\n      //   presence: true,\n      //   // and must be born at least 18 years ago\n      //   date: {\n      //     latest: moment().subtract(18, \"years\"),\n      //     message: \"^You must be at least 18 years old to use this service\"\n      //   }\n      // },\n      country: {\n        // You also need to input where you live\n        presence: true,\n        // And we restrict the countries supported to Sweden\n        inclusion: {\n          within: [\"SE\"],\n          // The ^ prevents the field name from being prepended to the error\n          message: \"^Sorry, this service is for Sweden only\"\n        }\n      },\n      zip: {\n        // Zip is optional but if specified it must be a 5 digit long number\n        format: {\n          pattern: \"\\\\d{5}\"\n        }\n      },\n      \"number-of-children\": {\n        presence: true,\n        // Number of children has to be an integer >= 0\n        numericality: {\n          onlyInteger: true,\n          greaterThanOrEqualTo: 0\n        }\n      },\n      \"Телефон\": {\n        presence: true,\n        isMaskComplete: true\n      }\n    };\n    return _this5;\n  }\n\n  _createClass(Form, [{\n    key: \"init\",\n    value: function init() {\n      var _this6 = this;\n\n      var form = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : \"form\";\n\n      validate_js__WEBPACK_IMPORTED_MODULE_1___default.a.validators.isMaskComplete = function (value, options, key, attributes) {\n        if (key == \"Телефон\" && options == true && value != null) {\n          if (_this6.PhoneMask().checkCompleteness(value)) {\n            return null;\n          } else {\n            return \"не корректен\";\n          }\n        } else {\n          return null;\n        }\n      };\n\n      this.disableIMask || this.phoneMask(form); // Hook up the form so we can prevent it from being posted\n\n      document.querySelectorAll(form).forEach(function (el) {\n        el.addEventListener(\"submit\", function (ev) {\n          ev.preventDefault();\n\n          _this6.handleFormSubmit(el);\n        });\n      }); // Hook up the inputs to validate on the fly\n\n      document.querySelectorAll(\"\".concat(form, \" input, \").concat(form, \" textarea, \").concat(form, \" select\")).forEach(function (el) {\n        el.addEventListener(\"change\", function (ev) {\n          var target = ev.target;\n          var currentForm = target.closest(form);\n          var errors = validate_js__WEBPACK_IMPORTED_MODULE_1___default()(currentForm, _this6.formConstraints(currentForm)) || {};\n\n          _this6.showErrorsForInput(target, errors[target.name]);\n        });\n\n        if (_this6.removeErrorOnFocus) {\n          el.addEventListener('focus', function (ev) {\n            ev.target.closest(_this6.formInput).classList.remove(_this6.classHasError);\n          });\n        }\n      });\n    }\n  }, {\n    key: \"phoneMask\",\n    value: function phoneMask(form) {\n      var _this7 = this;\n\n      document.querySelectorAll(\"\".concat(form, \" input.phone\")).forEach(function (e) {\n        _this7.PhoneMask(e);\n      });\n    }\n  }, {\n    key: \"handleFormSubmit\",\n    value: function handleFormSubmit(form, input) {\n      // validate the form against the constraints\n      var errors = validate_js__WEBPACK_IMPORTED_MODULE_1___default()(form, this.formConstraints(form)); // then we update the form to reflect the results\n\n      this.showErrors(form, errors || {});\n\n      if (!errors) {\n        this.showSuccess(form);\n      }\n    } // Updates the inputs with the validation errors\n\n  }, {\n    key: \"showErrors\",\n    value: function showErrors(form, errors) {\n      var _this8 = this;\n\n      // We loop through all the inputs and show the errors for that input\n      // Since the errors can be null if no errors were found we need to handle\n      // that\n      form.querySelectorAll(\"input[name], select[name], textarea[name]\").forEach(function (input) {\n        return _this8.showErrorsForInput(input, errors && errors[input.name]);\n      });\n    } // Shows the errors for a specific input\n\n  }, {\n    key: \"showErrorsForInput\",\n    value: function showErrorsForInput(input, errors) {\n      var _this9 = this;\n\n      // This is the root of the input\n      var formGroup = input.closest(this.formInput); // Find where the error messages will be insert into\n\n      var messages = null;\n\n      if (formGroup != null) {\n        if (!this.disableMessages) {\n          messages = formGroup.querySelector(this.selectorMessages);\n        } // First we remove any old messages and resets the classes\n\n\n        this.resetFormGroup(formGroup); // If we have errors\n\n        if (errors) {\n          // we first mark the group has having errors\n          formGroup.classList.add(this.classHasError); // then we append all the errors\n\n          errors.forEach(function (error) {\n            return _this9.addError(error, messages);\n          });\n        } else {\n          // otherwise we simply mark it as success\n          formGroup.classList.add(this.classHasSuccess);\n        }\n      }\n    }\n  }, {\n    key: \"resetFormGroup\",\n    value: function resetFormGroup(formGroup) {\n      // Remove the success and error classes\n      formGroup.classList.remove(this.classHasError);\n      formGroup.classList.remove(this.classHasSuccess); // and remove any old messages\n\n      formGroup.querySelectorAll(\".help-block.error\").forEach(function (el) {\n        return el.parentNode.removeChild(el);\n      });\n    } // Adds the specified error with the following markup\n    // <p class=\"help-block error\">[message]</p>\n\n  }, {\n    key: \"addError\",\n    value: function addError(error, messages) {\n      var block = document.createElement(\"p\");\n      block.classList.add(\"help-block\");\n      block.classList.add(\"error\");\n      block.innerText = error;\n\n      if (!this.disableMessages && messages != null) {\n        messages.appendChild(block);\n      }\n    }\n  }, {\n    key: \"showSuccess\",\n    value: function showSuccess(form) {\n      var formData = new FormData(form); // if (form.classList.contains(`form-quiz`)) {\n      //     ym(71270149,'reachGoal','quiz')\n      // } else {\n      //     ym(71270149,'reachGoal','form')\n      // }\n\n      uikit__WEBPACK_IMPORTED_MODULE_0___default.a.modal(\"#thanks\").show();\n      fetch(\"\".concat(this._apiBase, \"mail.php\"), {\n        method: 'post',\n        body: formData,\n        mode: 'no-cors'\n      }).then(function (response) {\n        // console.log(response)\n        return response.text();\n      }).then(function (text) {// console.log(text)\n      })[\"catch\"](function (error) {\n        console.error(error);\n      });\n    }\n  }, {\n    key: \"formConstraints\",\n    value: function formConstraints(form) {\n      var _this10 = this;\n\n      var localConstraints = {};\n      form.querySelectorAll(\"input[name], select[name], textarea[name]\").forEach(function (e) {\n        if (_this10.constraints[e.name] != undefined) {\n          localConstraints[e.name] = _this10.constraints[e.name];\n        }\n      });\n      return localConstraints;\n    }\n  }]);\n\n  return Form;\n}(App);\n\n\n\n//# sourceURL=webpack:///./src/modules/scripts/_core.js?");
...
eval("module.exports = __webpack_require__(/*! D:\\Программирование\\Web Programing\\WEB\\Lager\\src\\assets\\scripts\\main.js */\"./src/assets/scripts/main.js\");\n\n\n//# sourceURL=webpack:///multi_./src/assets/scripts/main.js?");
